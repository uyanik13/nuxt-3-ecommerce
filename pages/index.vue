<template>
  <section class="container px-2 py-12 mx-auto">
    <div class="flex flex-wrap w-full mb-8">
      <div class="w-full mb-6 lg:mb-0">
        <h1
          class="sm:text-4xl text-5xl font-bold title-font mb-2 text-gray-900"
        >
          List Product
        </h1>
    ...
    <div class="flex flex-wrap p-2">
      <div
        class="lg:w-1/4 w-1/2 bg-white rounded-lg p-3 m-2"
